...
\begin{definition} Conditional, in other words \textit{``if statement''}.
  ...
  \end{align*}
\end{definition}
\noindent The \IF \ statement is just a combinator that happens to behave similarly to a branching statement whenever we pass a church encoded boolean as a first argument.
