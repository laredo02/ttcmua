...
\end{remark}
\subsubsection{\centering Lists from Pairs}
...
\end{remark}
\begin{definition} A \PAIR \ is nothing but a relation $\langle A, B \rangle \in A \times B$. We now define the corresponding projections $\pi_1 \langle A, B \rangle = A$ as \FST \ and $\pi_1 \langle A, B \rangle = B$ as \SND: 
  \[
    \begin{aligned}
...
\begin{proposition} A key property of $ \PAIR $'s is:
  \[\PAIR \, A \, B \equiv_\beta \PAIR \, (\FST \, (\PAIR \, A \, B)) \, (\SND \, (\PAIR \, A \, B)) \]
\end{proposition}
