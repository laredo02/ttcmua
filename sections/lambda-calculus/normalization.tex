...
\begin{remark} If you have no time to waste, \cite{nagele2016mechanized} is a mechanized proof of the Church-Rosser Theorem using the $Z$-property written in Nominal Isabelle, which enables you to swiftly glance over the following section.
\end{remark}
