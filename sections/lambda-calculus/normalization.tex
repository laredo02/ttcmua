...
The following section covers the proof of this property for the untyped \lcalc. We deemed it necessary to include the proof since it provides evidence that the \lcalc is a viable system to perform computation with, since it ensures that no matter what reduction path we choose first the reduction can always converge into a unique term. See \ref{cor:unique-normal-form}. This notion of confluence is strengthened when we introduce typing \ref{sec:typed-normalization}.
