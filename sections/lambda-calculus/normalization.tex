\subsection{\centering Normalization \& The Church-Rosser Theorem}
...
\end{proof}
\begin{remark}
  Checking whether a term is non-terminating or not is undecidable. It is an instance of the halting problem.
\end{remark}
